Shader "UltimateWater/Variations/Water _ALPHABLEND_ON _CUBEMAP_REFLECTIONS _INCLUDE_SLOPE_VARIANCE _PLANAR_REFLECTIONS_HQ _WATER_RECEIVE_SHADOWS _WATER_REFRACTION _WATER_OVERLAYS _WAVES_FFT _PROJECTION_GRID"
{
    Properties
    {
            ...
            SubShader
        {
			...
			#pragma multi_compile _WAVES_FFT
						...
						#pragma multi_compile _PROJECTION_GRID_OFF _PROJECTION_GRID
