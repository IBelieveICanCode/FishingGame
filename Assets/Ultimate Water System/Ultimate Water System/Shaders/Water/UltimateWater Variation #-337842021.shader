Shader "UltimateWater/Variations/Water _ALPHABLEND_ON _CUBEMAP_REFLECTIONS _PLANAR_REFLECTIONS _WATER_REFRACTION _BOUNDED_WATER _TRIANGLES _WATER_OVERLAYS _WAVES_ALIGN _WAVES_FFT"
{
    Properties
    {
            ...
            SubShader
        {
			...
			#pragma multi_compile _BOUNDED_WATER
			#pragma multi_compile _TRIANGLES
			#pragma multi_compile _WATER_OVERLAYS
			#pragma multi_compile _WAVES_ALIGN
			...
			#pragma multi_compile _WAVES_FFT
                ...
                #define POST_TESS_VERT VertMotionVectors
                #define TESS_OUTPUT MotionVectorData
